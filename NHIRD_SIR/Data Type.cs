...
namespace NHIRD.DataTypes
{
    ...
    class NHIRD_DataTypes
    {
        ...
        internal class ActionBasedData_OrderComparer : IComparer<ActionBasedData>
        {
            ...
            {
                return (x.str_HospID + x.str_ApplDate + x.str_SeqNO).CompareTo(y.str_HospID + y.str_ApplDate + y.str_SeqNO);
            }
        }
        /// <summary>
        ...
        /// </summary>
        public sealed class Bank_ActionBasedData<T> : IComparable<Bank_ActionBasedData<T>>
        {
            public string str_FeeYM { get; }
            public List<T> list_ActionBasedData_CD;
            // -- constructor
            public Bank_ActionBasedData(string str_FeeYm)
            {
                this.str_FeeYM = str_FeeYm;
                this.list_ActionBasedData_CD = new List<T>();
            }
            // -- compare method
            public int CompareTo(Bank_ActionBasedData<T> other)
            {
    ...
    {
        // -- Constructor
        public NHIRD_ArgTable(string DatabaseYear, int DataStartYear, int DataEndYear, string OrderGroupPath)
        {
            GroupDefinition.initiallizeOrder(this, OrderGroupPath);
        ...
        /// </summary>
        public List<NHIRD_DataTypes.Bank_ActionBasedData<NHIRD_DataTypes.ActionBasedData_CD>> databank_PrimaryActionBasedData_CD;
    ...
    class SumData
    {
        ...
        public SumData(List<NHIRD.DataTypes.SecondDiagnosisGroup> second_Diagnosis_Group)
        {
